...
class DetailedInfo extends Component {
  render() {
    ...
    const level4Panels = [
      ...
      { key: "panel-2a", title: "Street", content: cardDetail.address.street },
      { key: "panel-2b", title: "zipCode", content: cardDetail.address.zipCode }
    ];
    const Level1Content = (
      <div>
      ...
      <div className="detailed-info-card">
        <div className="substrate__main">
          ...
          <div>
            ...
            {cardDetail.address.country}
            {cardDetail.address.city}
            {cardDetail.address.street}
            {cardDetail.address.zipCode} */}
          </div>
        </div>
